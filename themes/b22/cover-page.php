...
<div class="cover_nav">
	<div id="page_wrap" class="container home">
		...
		<div class="row">
			<div class="col-xs-3 col-s-3 col-md-2 col-lg-2">
				<div class="news_post">
			...
			<div class="col-xs-6 col-s-6 col-md-4 col-lg-4">
				<div class="news_post"> <!-- get post from the “featured” category -->
					<?php echo do_shortcode("[list-news-items count=1 show_excerpt=1 category='featured']"); ?>
				</div>
			</div>

			<div class="col-xs-3 col-s-3 col-md-6 col-lg-6">
